...
public class TasksUtilities {
    ...
    public static final String CREATE_TASKS_TABLE="CREATE TABLE "+TABLE_NAME+"("+COLUMN_TASK_ID+" INTEGER PRIMARY KEY AUTOINCREMENT NULL,"+COLUMN_TASK_TITLE+" TEXT NOT NULL,"+
            COLUMN_TASK_DETAILS+" TEXT NOT NULL,"+COLUMN_TASK_DONE+" INTEGER NULL DEFAULT 0,"+COLUMN_TASK_YEAR+" INTEGER NULL,"+COLUMN_TASK_MONTH+" INTEGER NULL,"+
            COLUMN_TASK_DAY+" INTEGER NULL,"+COLUMN_TASK_HOUR+" INTEGER NULL,"+COLUMN_TASK_MINUTE+" INTEGER NULL)";
}
