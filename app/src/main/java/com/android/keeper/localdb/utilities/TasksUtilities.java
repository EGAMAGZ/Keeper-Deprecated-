...
public class TasksUtilities {
    ...
    public static final String CREATE_TASKS_TABLE="CREATE TABLE "+TABLE_NAME+"("+COLUMN_TASK_ID+" INTEGER PRIMARY KEY NULL,"+COLUMN_TASK_TITLE+" TEXT,"+COLUMN_TASK_DESCRIPTION+" TEXT)";
}
